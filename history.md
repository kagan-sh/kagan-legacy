...
External contract impact: ⚠️ GitHub MCP tools must remain unchanged — github\_\* tool names, parameters, and response shapes
Test strategy:
...
Manual: verify all github\_\* MCP tools work from Claude Code
...
Plugin contract: GitHub plugin loads and operates identically. github\_\* MCP tools unchanged.
...
Best practice: Use reactive for state, watch\_\* methods for reactions, post_message for events
