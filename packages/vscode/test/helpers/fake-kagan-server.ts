...
export const TEST_TASK: WireTask = {
  ...
  priority: "HIGH",
  base_branch: "main",
  acceptance_criteria: ["Open the diff view", "Open the review summary"],
  agent_backend: "claude-code",
  launcher: "vscode",
  review_approved: false,
  review_verdicts: [
    { criterion_index: 0, verdict: "PASS", reason: "Diff view opens correctly." },
    { criterion_index: 1, verdict: "FAIL", reason: "Review still needs a human check." },
  ],
