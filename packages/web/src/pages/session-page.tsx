...
export function Component() {
    ...
    const [worktree, setWorktree] = useState<
        TaskWorktreeResponse["worktree"] | null
    >(null);
    ...
    const reviewerSession = useMemo(
        () =>
            sessionsPreload.length >= 2
                ? sessionsPreload[sessionsPreload.length - 1]
                : undefined,
        [sessionsPreload],
    );
    ...
    const laneSessionId =
        streamLane === "reviewer" ? reviewerSession?.id : workerSession?.id;
        ...
        <ErrorBoundary level="feature">
            <div className="mx-auto flex h-full w-full max-w-[1680px] min-h-0 flex-col px-4 py-3 sm:px-6">
                <div className="flex items-center gap-2 border-b border-[color:var(--border-subtle)] pb-3">
                    ...
                    {(displayTask.active_session?.agent_backend ??
                    displayTask.agent_backend) ? (
                    ...
                    <div className="grid min-h-0 flex-1 gap-5 p-5 xl:grid-cols-[minmax(0,1fr)_20rem]">
                        ...
                        <div className="min-h-0 space-y-4 overflow-y-auto pr-1">
                            ...
                            <TaskMetadataPanel
                                ...
                                runtimeRows={[
                                    ...
                                    },
                                    {
                                        ...
                                        value:
                                            worktree?.path ||
                                            "No active worktree path",
                                        rowClassName:
                                            "flex items-start justify-between gap-2",
                                        valueClassName:
                                            "max-w-[12rem] text-right text-xs leading-5 text-[var(--muted-foreground)]",
                                    },
                                ]}
                            />
                            ...
                            <TaskCommitsPanel
                                ...
                                branch={
                                    commits?.branch ?? worktree?.branch ?? null
                                }
                                baseBranch={
                                    commits?.base_branch ??
                                    displayTask.base_branch ??
