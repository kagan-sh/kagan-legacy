...
async function expectNoViolations(container: HTMLElement) {
  ...
  // Flag serious/critical incomplete checks, but skip known jsdom false positives:
  //  - color-contrast "error-occurred": jsdom has no rendering engine (canvas is null)
  //  - aria-valid-attr-value "controlsWithinPopup": Radix popovers reference IDs
  //    for content not yet rendered in the DOM
