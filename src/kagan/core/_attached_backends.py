...
ATTACHED_TERMINAL_BACKEND_SPECS: Final[tuple[AttachedTerminalBackendSpec, ...]] = (
    AttachedTerminalBackendSpec(value=TMUX_BACKEND, label="tmux", executable="tmux"),
    AttachedTerminalBackendSpec(value=NVIM_BACKEND, label="Neovim", executable="nvim"),
    AttachedTerminalBackendSpec(value=VSCODE_BACKEND, label="VS Code", executable="code"),
    AttachedTerminalBackendSpec(value=CURSOR_BACKEND, label="Cursor", executable="cursor"),
    AttachedTerminalBackendSpec(value=WINDSURF_BACKEND, label="Windsurf", executable="windsurf"),
    AttachedTerminalBackendSpec(value=KIRO_BACKEND, label="Kiro", executable="kiro"),
    AttachedTerminalBackendSpec(value=ANTIGRAVITY_BACKEND, label="Antigravity", executable="agy"),
)
