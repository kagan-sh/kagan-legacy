...
_TASK_TYPE_KEYWORDS = {
    TaskType.CODE_IMPLEMENTATION: {
        "keywords": [
            ...
            "write", "new endpoint", "api", "function", "module",
            "feature request", "feature", "new functionality",
        ],
        "priority": 10,
    },
    TaskType.BUG_FIX: {
        "keywords": [
            "bug", "fix", "broken", "crash", "error", "exception",
            "failing", "not working", "issue", "regression", "defect",
        ],
        "priority": 9,
    },
    TaskType.REFACTORING: {
        "keywords": [
            ...
            "reorganize", "simplify", "reduce duplication", "dry",
            "improve readability", "technical debt", "modernize",
        ],
        "priority": 8,
    },
    TaskType.TESTING: {
        "keywords": [
            ...
            "test coverage", "jest", "pytest", "vitest", "mocha",
            "e2e test", "automated test",
        ],
        "priority": 7,
    },
    TaskType.OPTIMIZATION: {
        "keywords": [
            "optimize", "performance", "perf", "slow", "latency",
            "throughput", "memory", "caching", "cache", "speed",
    ...
    TaskType.DOCUMENTATION: {
        "keywords": [
            "document", "docs", "readme", "comment", "jsdoc",
            "docstring", "wiki", "guide", "tutorial", "handbook",
        ],
        "priority": 5,
    },
    TaskType.ARCHITECTURE: {
        "keywords": [
            "architecture", "design system", "structural",
            "component design", "system design", "schema",
            "scalability", "microservice", "service",
        ],
        "priority": 4,
    },
    TaskType.DESIGN: {
        "keywords": [
            "design", "ux", "ui", "user experience", "interface",
            "styling", "layout", "component", "visual",
        ],
        "priority": 3,
    },
    TaskType.ANALYSIS: {
        "keywords": [
            "analyze", "analysis", "investigate", "research",
            "understand", "explore", "review code", "code review",
            "audit", "assessment",
        ],
        "priority": 2,
    },
    TaskType.INVESTIGATION: {
        "keywords": [
            ...
            "root cause", "trace", "profile", "why is",
        ],
        "priority": 2,
    },
    TaskType.DEPLOYMENT: {
