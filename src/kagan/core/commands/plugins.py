...
async def tui_api_call(ctx: AppContext, params: dict[str, Any]) -> dict[str, Any]:
    """Compatibility alias for the TUI direct-call command."""
    from kagan.core.commands.workspaces import handle_tui_api_call

    return await handle_tui_api_call(ctx, params)
