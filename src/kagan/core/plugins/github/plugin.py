...
def _plugin_handlers_module() -> Any:
    ...
    module_name = "kagan.core.plugins.github.entrypoints.plugin_handlers"
    try:
            ...
            async def _sync() -> None:
                try:
                    ...
                    if to_status_str == "REVIEW":
                        try:
                            from kagan.core.plugins.github.adapters.core_gateway import (
                                AppContextCoreGateway,
                            )
                            from kagan.core.plugins.github.adapters.gh_cli_client import (
                                GhCliClientAdapter,
                            )
