"""Queued message service for automation sessions."""
...
class QueuedMessageServiceImpl:
    ...
    async def queue_message(
        ...
        *,
        ...
        normalized_content = normalize_untrusted_text(content, max_chars=QUEUE_MESSAGE_MAX_CHARS)
        safe_content = redact_sensitive_text(normalized_content, redact_pii=True)
        safe_metadata = (
            redact_sensitive_payload(metadata, redact_pii=True)
