...
if TYPE_CHECKING:
    ...
    from kagan.services.types import ExecutionId, TaskId
...
class ReviewServiceImpl:
    """Review service backed by TaskService and ExecutionService."""

    def __init__(self, task_service: TaskService, execution_service: ExecutionService) -> None:
    ...
    async def start_review(self, task_id: TaskId, execution_id: ExecutionId) -> None:
        ...
        await self._executions.append_log(execution_id, self._serialize_note(note))
