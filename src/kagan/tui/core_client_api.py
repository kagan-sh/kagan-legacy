...
This module provides CoreBackedApi which wraps KaganSDK for backward compatibility.
"""
...
class CoreBackedApi:
    ...
    This is a thin wrapper around KaganSDK that provides the same interface
    as the original IPC-based implementation for backward compatibility.
    """
    ...
    async def add_repo(
        ...
        *,
        ...
        return result.project.get("repo_id", "") if result.project else ""
...
class PluginUiRefresh(dict):
    pass


class PluginUiInvokeResult(dict):
    pass


class PluginUiCatalog(dict):
    pass
