...
_PACKAGE_MARKERS = frozenset({"core", "mcp", "tui", "plugins", "integration"})
_TYPE_MARKERS = frozenset({"unit", "fast", "contract", "snapshot", "smoke", "e2e"})
_DEPRECATED_TEST_MARKERS: frozenset[str] = frozenset()
