...
@pytest.fixture
async def e2e_app_without_tasks(e2e_project):
    """Create a KaganApp with a linked project/repo and no board tasks."""
    return await _create_e2e_app_with_tasks(e2e_project, [])
