...
from kagan.core.agents.installer import (
    AgentType,
    _check_prerequisites,
    _get_path_hint,
    check_agent_installed,
)
from kagan.core.builtin_agents import get_agent_status, list_available_agents
...
class TestGetAgentStatus:
    ...
    def test_returns_dict_with_all_six_agents(self) -> None:
        ...
        with patch(
            "kagan.core.builtin_agents._check_command_available",
            return_value=False,
        ):
